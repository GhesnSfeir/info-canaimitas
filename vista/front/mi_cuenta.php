    ...
    <div class="col-md-6">
        <form class="form-horizontal">
           ...
           <div class="form-group">
                ...
                <input type="text" id="nombre" name="nombre" class="form-control mediano" placeholder="Alejandro" disabled>
            </div>
            
            <div class="form-group">
                <label for="apellido" class="col-md-5 control-label">Apellido: </label>
                <input type="text" id="apellido" name="apellido" class="form-control mediano" placeholder="D. M" disabled>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="sexo" name="sexo" class="form-control mediano" disabled>
